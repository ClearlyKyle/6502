...
static void CMP_IND_Y(struct CMP_Test_Data test)
{
    // given:
    cpu.program_counter = 0xFF00;
    cpu.C               = !test.expect_C;
...
// Indirect Y
void CMP_IND_Y_Can_Compare_Two_Identical_Values(void)
{
    struct CMP_Test_Data test = Compare_Two_Identical_Values();
    CMP_IND_Y(test);
}

void CMP_IND_Y_Can_Compare_A_Large_Positive_To_A_Small_Positive(void)
{
    struct CMP_Test_Data test = Compare_A_Large_Positive_To_A_Small_Positive();
    CMP_IND_Y(test);
}

void CMP_IND_Y_Can_Compare_A_Negative_Number_To_A_Positive(void)
{
    struct CMP_Test_Data test = Compare_A_Negative_Number_To_A_Positive();
    CMP_IND_Y(test);
}

void CMP_IND_Y_Can_Compare_Two_Values_That_Result_In_A_Negative_Flag_Set(void)
{
    struct CMP_Test_Data test = Compare_Two_Values_That_Result_In_A_Negative_Flag_Set();
    CMP_IND_Y(test);
}
...
// CPY Immediate
void CPY_IM_Can_Compare_Two_Identical_Values(void)
{
    struct CMP_Test_Data test = Compare_Two_Identical_Values();
    CMP_IM(test, REGISTER_Y);
}

void CPY_IM_Can_Compare_A_Large_Positive_To_A_Small_Positive(void)
{
    struct CMP_Test_Data test = Compare_A_Large_Positive_To_A_Small_Positive();
    CMP_IM(test, REGISTER_Y);
}

void CPY_IM_Can_Compare_A_Negative_Number_To_A_Positive(void)
{
    struct CMP_Test_Data test = Compare_A_Negative_Number_To_A_Positive();
    CMP_IM(test, REGISTER_Y);
}

void CPY_IM_Can_Compare_Two_Values_That_Result_In_A_Negative_Flag_Set(void)
{
    struct CMP_Test_Data test = Compare_Two_Values_That_Result_In_A_Negative_Flag_Set();
    CMP_IM(test, REGISTER_Y);
}
...
// CPX Zero Page
void CPX_ZP_Can_Compare_Two_Identical_Values(void)
{
    struct CMP_Test_Data test = Compare_Two_Identical_Values();
    CMP_ZP(test, REGISTER_X);
}

void CPX_ZP_Can_Compare_A_Large_Positive_To_A_Small_Positive(void)
{
    struct CMP_Test_Data test = Compare_A_Large_Positive_To_A_Small_Positive();
    CMP_ZP(test, REGISTER_X);
}

void CPX_ZP_Can_Compare_A_Negative_Number_To_A_Positive(void)
{
    struct CMP_Test_Data test = Compare_A_Negative_Number_To_A_Positive();
    CMP_ZP(test, REGISTER_X);
}

void CPX_ZP_Can_Compare_Two_Values_That_Result_In_A_Negative_Flag_Set(void)
{
    struct CMP_Test_Data test = Compare_Two_Values_That_Result_In_A_Negative_Flag_Set();
    CMP_ZP(test, REGISTER_X);
}
...
// CPX Absolute
void CPX_ABS_Can_Compare_Two_Identical_Values(void)
{
    struct CMP_Test_Data test = Compare_Two_Identical_Values();
    CMP_ABS(test, REGISTER_X);
}

void CPX_ABS_Can_Compare_A_Large_Positive_To_A_Small_Positive(void)
{
    struct CMP_Test_Data test = Compare_A_Large_Positive_To_A_Small_Positive();
    CMP_ABS(test, REGISTER_X);
}

void CPX_ABS_Can_Compare_A_Negative_Number_To_A_Positive(void)
{
    struct CMP_Test_Data test = Compare_A_Negative_Number_To_A_Positive();
    CMP_ABS(test, REGISTER_X);
}

void CPX_ABS_Can_Compare_Two_Values_That_Result_In_A_Negative_Flag_Set(void)
{
    struct CMP_Test_Data test = Compare_Two_Values_That_Result_In_A_Negative_Flag_Set();
    CMP_ABS(test, REGISTER_X);
}
...
// CPY Absolute
void CPY_ABS_Can_Compare_Two_Identical_Values(void)
{
    struct CMP_Test_Data test = Compare_Two_Identical_Values();
    CMP_ABS(test, REGISTER_Y);
}

void CPY_ABS_Can_Compare_A_Large_Positive_To_A_Small_Positive(void)
{
    struct CMP_Test_Data test = Compare_A_Large_Positive_To_A_Small_Positive();
    CMP_ABS(test, REGISTER_Y);
}

void CPY_ABS_Can_Compare_A_Negative_Number_To_A_Positive(void)
{
    struct CMP_Test_Data test = Compare_A_Negative_Number_To_A_Positive();
    CMP_ABS(test, REGISTER_Y);
}

void CPY_ABS_Can_Compare_Two_Values_That_Result_In_A_Negative_Flag_Set(void)
{
    struct CMP_Test_Data test = Compare_Two_Values_That_Result_In_A_Negative_Flag_Set();
    CMP_ABS(test, REGISTER_Y);
}
...
int main(void)
{
    ...
    // Indirect Y
    RUN_TEST(CMP_IND_Y_Can_Compare_Two_Identical_Values);
    ...
    // CPY Immediate
    RUN_TEST(CPY_IM_Can_Compare_Two_Identical_Values);
    RUN_TEST(CPY_IM_Can_Compare_A_Large_Positive_To_A_Small_Positive);
    RUN_TEST(CPY_IM_Can_Compare_A_Negative_Number_To_A_Positive);
    RUN_TEST(CPY_IM_Can_Compare_Two_Values_That_Result_In_A_Negative_Flag_Set);

    // CPX Zero Page
    RUN_TEST(CPX_ZP_Can_Compare_Two_Identical_Values);
    RUN_TEST(CPX_ZP_Can_Compare_A_Large_Positive_To_A_Small_Positive);
    ...
    // CPX Absolute
    RUN_TEST(CPX_ABS_Can_Compare_Two_Identical_Values);
    RUN_TEST(CPX_ABS_Can_Compare_A_Large_Positive_To_A_Small_Positive);
    RUN_TEST(CPX_ABS_Can_Compare_A_Negative_Number_To_A_Positive);
    RUN_TEST(CPX_ABS_Can_Compare_Two_Values_That_Result_In_A_Negative_Flag_Set);

    // CPY Absolute
    RUN_TEST(CPY_ABS_Can_Compare_Two_Identical_Values);
    RUN_TEST(CPY_ABS_Can_Compare_A_Large_Positive_To_A_Small_Positive);
    RUN_TEST(CPY_ABS_Can_Compare_A_Negative_Number_To_A_Positive);
    RUN_TEST(CPY_ABS_Can_Compare_Two_Values_That_Result_In_A_Negative_Flag_Set);
